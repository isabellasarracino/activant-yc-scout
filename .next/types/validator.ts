...
// Validate ../../src/app/api/batches/[batch]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/batches/[batch]">> = Specific
  const handler = {} as typeof import("../../src/app/api/batches/[batch]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
